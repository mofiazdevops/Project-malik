...
export const StakingCard = (props: IStaking) => {
  ...
  const dateComparision = (_startDate: Date, _endDate: Date) => {
    ...
    const timee = `Finishing in ${hDiff <= 0 ? 0 : Math.floor(hDiff)} hours, ${
      minDiff <= 0 ? 0 : Math.floor(minDiff)
    } minutes`;
    ...
    <div className={classes.root}>
      <div className={classes.wrapper}>
        <Grid container justifyContent="space-between">
          <Grid className={classes.breadcrumb} container item md={12} xs={12}>
          ...
          <Grid
            ...
            spacing={3}
          >
            <Grid className={classes.cardGrid} container item md={12} xs={12}>
              <Grid
              ...
              >
                ...
                <Grid className={classes.cardPriceContainer} container item>
                  {loading ? (
                    <>
                    ...
                    <>
                      <Grid className={classes.cardPriceText} item xs={6}>
                        Locking Amount
                      </Grid>
                      <Grid
                      ...
                      <Grid
                        ...
                        xs={6}
                      >
                        {moment(staking?.endDate).format("DD-MM-YYYY hh:mm A")}
                      </Grid>
                      ...
                      >
                        {"IDEA " +
                          (staking?.percentage / 100) * staking.amount || 0}
                      </Grid>
                    </>
                  )}
                </Grid>
                    ...
                    <>
                      <div className={classes.progressBarTop}>
                        ...
                        <span className={classes.percentage}>
                          {dateComparision(staking.createdAt, staking.endDate)
                            .percentage + "%"}
                        </span>
                      </div>
                      ...
                      <LinearProgress
                        ...
                        variant="determinate"
                      />
                      <div className={classes.progressBarBottom}></div>
                      <div
                        style={{
                      ...
                      >
                        <Button
                          ...
                          color="primary"
                          onClick={viewStaking(staking._id)}
                          size="small"
                          type="submit"
                          variant="contained"
                        >
...
const useStyles = makeStyles((theme: any) => ({
  ...
  socialIcon: {
    ...
    "&:hover": {
      filter:
        "invert(24%) sepia(97%) saturate(1806%) hue-rotate(188deg) brightness(99%) contrast(91%)",
    },
  },
  iconText: {
    marginTop: "6px",
